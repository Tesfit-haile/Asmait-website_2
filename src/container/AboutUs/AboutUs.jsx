      ...
      <div className="app__aboutus-content flex__center">
        ...
        <div className="app__aboutus-contnet_about">
          ...
          <p className="p__opensans">
            ንልዕሊ 3 ዓመታትን ዝበለጹ ናይ መርዓታትን፤ ጥምቀታትን፥ ኣብ በዓልት ዝግበሩ ጉዳያትን፥ ግብጃታትን ካለኦት ኣብ ዝተፈላለዩ ጉዳይት ዝግበሩ ጽምብላትን በቶም ኣዝዮም ምኩራትን ውሕሉላትን ዝዀኑ ሸፋትና ኣብ ዝደለኹሞ ግዜን ሰዓት ከምት ዝጠለብክሞ ጌርና ጉዳይኩም ከነጸብቀልሙ ድልዋት ኢና።</p>
